//HTML5 SHIV
!function(e,n,t){function o(e,n){return typeof e===n}function r(){var e,n,t,r,s,i,a;for(var f in w)if(w.hasOwnProperty(f)){if(e=[],n=w[f],n.name&&(e.push(n.name.toLowerCase()),n.options&&n.options.aliases&&n.options.aliases.length))for(t=0;t<n.options.aliases.length;t++)e.push(n.options.aliases[t].toLowerCase());for(r=o(n.fn,"function")?n.fn():n.fn,s=0;s<e.length;s++)i=e[s],a=i.split("."),1===a.length?Modernizr[a[0]]=r:(!Modernizr[a[0]]||Modernizr[a[0]]instanceof Boolean||(Modernizr[a[0]]=new Boolean(Modernizr[a[0]])),Modernizr[a[0]][a[1]]=r),C.push((r?"":"no-")+a.join("-"))}}function s(){return"function"!=typeof n.createElement?n.createElement(arguments[0]):T?n.createElementNS.call(n,"http://www.w3.org/2000/svg",arguments[0]):n.createElement.apply(n,arguments)}function i(e){var n=S.className,t=Modernizr._config.classPrefix||"";if(T&&(n=n.baseVal),Modernizr._config.enableJSClass){var o=new RegExp("(^|\\s)"+t+"no-js(\\s|$)");n=n.replace(o,"$1"+t+"js$2")}Modernizr._config.enableClasses&&(n+=" "+t+e.join(" "+t),T?S.className.baseVal=n:S.className=n)}function a(e,n){if("object"==typeof e)for(var t in e)x(e,t)&&a(t,e[t]);else{e=e.toLowerCase();var o=e.split("."),r=Modernizr[o[0]];if(2==o.length&&(r=r[o[1]]),"undefined"!=typeof r)return Modernizr;n="function"==typeof n?n():n,1==o.length?Modernizr[o[0]]=n:(!Modernizr[o[0]]||Modernizr[o[0]]instanceof Boolean||(Modernizr[o[0]]=new Boolean(Modernizr[o[0]])),Modernizr[o[0]][o[1]]=n),i([(n&&0!=n?"":"no-")+o.join("-")]),Modernizr._trigger(e,n)}return Modernizr}function f(e,n){return!!~(""+e).indexOf(n)}function l(e){return e.replace(/([a-z])-([a-z])/g,function(e,n,t){return n+t.toUpperCase()}).replace(/^-/,"")}function u(e,n){return function(){return e.apply(n,arguments)}}function d(e,n,t){var r;for(var s in e)if(e[s]in n)return t===!1?e[s]:(r=n[e[s]],o(r,"function")?u(r,t||n):r);return!1}function c(e){return e.replace(/([A-Z])/g,function(e,n){return"-"+n.toLowerCase()}).replace(/^ms-/,"-ms-")}function p(){var e=n.body;return e||(e=s(T?"svg":"body"),e.fake=!0),e}function m(e,t,o,r){var i,a,f,l,u="modernizr",d=s("div"),c=p();if(parseInt(o,10))for(;o--;)f=s("div"),f.id=r?r[o]:u+(o+1),d.appendChild(f);return i=s("style"),i.type="text/css",i.id="s"+u,(c.fake?c:d).appendChild(i),c.appendChild(d),i.styleSheet?i.styleSheet.cssText=e:i.appendChild(n.createTextNode(e)),d.id=u,c.fake&&(c.style.background="",c.style.overflow="hidden",l=S.style.overflow,S.style.overflow="hidden",S.appendChild(c)),a=t(d,e),c.fake?(c.parentNode.removeChild(c),S.style.overflow=l,S.offsetHeight):d.parentNode.removeChild(d),!!a}function h(n,o){var r=n.length;if("CSS"in e&&"supports"in e.CSS){for(;r--;)if(e.CSS.supports(c(n[r]),o))return!0;return!1}if("CSSSupportsRule"in e){for(var s=[];r--;)s.push("("+c(n[r])+":"+o+")");return s=s.join(" or "),m("@supports ("+s+") { #modernizr { position: absolute; } }",function(e){return"absolute"==getComputedStyle(e,null).position})}return t}function v(e,n,r,i){function a(){d&&(delete N.style,delete N.modElem)}if(i=o(i,"undefined")?!1:i,!o(r,"undefined")){var u=h(e,r);if(!o(u,"undefined"))return u}for(var d,c,p,m,v,g=["modernizr","tspan"];!N.style;)d=!0,N.modElem=s(g.shift()),N.style=N.modElem.style;for(p=e.length,c=0;p>c;c++)if(m=e[c],v=N.style[m],f(m,"-")&&(m=l(m)),N.style[m]!==t){if(i||o(r,"undefined"))return a(),"pfx"==n?m:!0;try{N.style[m]=r}catch(y){}if(N.style[m]!=v)return a(),"pfx"==n?m:!0}return a(),!1}function g(e,n,t,r,s){var i=e.charAt(0).toUpperCase()+e.slice(1),a=(e+" "+P.join(i+" ")+i).split(" ");return o(n,"string")||o(n,"undefined")?v(a,n,r,s):(a=(e+" "+z.join(i+" ")+i).split(" "),d(a,n,t))}function y(e,n,o){return g(e,t,t,n,o)}var w=[],_={_version:"3.2.0",_config:{classPrefix:"",enableClasses:!0,enableJSClass:!0,usePrefixes:!0},_q:[],on:function(e,n){var t=this;setTimeout(function(){n(t[e])},0)},addTest:function(e,n,t){w.push({name:e,fn:n,options:t})},addAsyncTest:function(e){w.push({name:null,fn:e})}},Modernizr=function(){};Modernizr.prototype=_,Modernizr=new Modernizr,Modernizr.addTest("svg",!!n.createElementNS&&!!n.createElementNS("http://www.w3.org/2000/svg","svg").createSVGRect);var x,C=[];!function(){var e={}.hasOwnProperty;x=o(e,"undefined")||o(e.call,"undefined")?function(e,n){return n in e&&o(e.constructor.prototype[n],"undefined")}:function(n,t){return e.call(n,t)}}();var S=n.documentElement,T="svg"===S.nodeName.toLowerCase();Modernizr.addTest("inlinesvg",function(){var e=s("div");return e.innerHTML="<svg/>","http://www.w3.org/2000/svg"==("undefined"!=typeof SVGRect&&e.firstChild&&e.firstChild.namespaceURI)}),_._l={},_.on=function(e,n){this._l[e]||(this._l[e]=[]),this._l[e].push(n),Modernizr.hasOwnProperty(e)&&setTimeout(function(){Modernizr._trigger(e,Modernizr[e])},0)},_._trigger=function(e,n){if(this._l[e]){var t=this._l[e];setTimeout(function(){var e,o;for(e=0;e<t.length;e++)(o=t[e])(n)},0),delete this._l[e]}},Modernizr._q.push(function(){_.addTest=a}),Modernizr.addTest("svgasimg",n.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#Image","1.1"));var b="Moz O ms Webkit",P=_._config.usePrefixes?b.split(" "):[];_._cssomPrefixes=P;var z=_._config.usePrefixes?b.toLowerCase().split(" "):[];_._domPrefixes=z;var E={elem:s("modernizr")};Modernizr._q.push(function(){delete E.elem});var N={style:E.elem.style};Modernizr._q.unshift(function(){delete N.style}),_.testAllProps=g,_.testAllProps=y,Modernizr.addTest("cssanimations",y("animationName","a",!0)),Modernizr.addTest("boxshadow",y("boxShadow","1px 1px",!0)),Modernizr.addTest("flexbox",y("flexBasis","1px",!0)),Modernizr.addTest("csstransforms",function(){return-1===navigator.userAgent.indexOf("Android 2.")&&y("transform","scale(1)",!0)});var j=_._config.usePrefixes?" -webkit- -moz- -o- -ms- ".split(" "):[];_._prefixes=j;var A=_.testStyles=m;Modernizr.addTest("touchevents",function(){var t;if("ontouchstart"in e||e.DocumentTouch&&n instanceof DocumentTouch)t=!0;else{var o=["@media (",j.join("touch-enabled),("),"heartz",")","{#modernizr{top:9px;position:absolute}}"].join("");A(o,function(e){t=9===e.offsetTop})}return t}),r(),delete _.addTest,delete _.addAsyncTest;for(var k=0;k<Modernizr._q.length;k++)Modernizr._q[k]();e.Modernizr=Modernizr}(window,document);
...
$(document).ready(function() {
	...
	$('.mobile-nav-trigger').click(function(e){
		e.preventDefault();
		if(bodyContainer.hasClass('cart-visible')){
			bodyContainer.removeClass('cart-visible');
			$('#shop-nav li a').removeClass('active-fixed');
		}
		if(bodyContainer.hasClass('account-visible')){
			bodyContainer.removeClass('account-visible');
			$('#shop-nav li a').removeClass('active-fixed');
		}
		if(windowContainer.width() >= 700 && bodyContainer.hasClass('search-visible')){
			$('#shop-nav li a').removeClass('active-fixed');
			bodyContainer.removeClass('search-visible');
		}
		bodyContainer.toggleClass('nav-visible');
		if(windowContainer.width() <= 700){
			if(!bodyContainer.hasClass('opened')){
				bodyContainer.addClass('opened');
			}
			setTimeout(function(){
				$('#mobile-nav li').each(function(i, el){
					setTimeout(function(){
						$(el).addClass('animate');
					}, i * 150);
				});
	...
	$('.search').click(function(e){
		if(windowContainer.width() >= 700 && bodyContainer.hasClass('nav-visible')){
			bodyContainer.removeClass('nav-visible');
		}
		e.preventDefault();
		$('#shop-nav li a').removeClass('active-fixed');
		$(this).toggleClass('active-fixed');
		bodyContainer.toggleClass('search-visible');
		$('.searchform #searchfield').focus();
	});

	// DESKTOP: Shopnav Events

	if(desktop == true){

		$('.cart-trigger').mouseenter(function(){
			$(this).addClass('active');
			bodyContainer.addClass('cart-visible');
		});

		$('.cart-trigger').mouseleave(function(){
		...
		$('.mini-cart-wrapper' ).mouseleave(function(){
			$('.cart-trigger').removeClass('active');
			bodyContainer.removeClass('cart-visible');
		});

		$('.account-trigger').mouseenter(function(){
			$(this).addClass('active');
			bodyContainer.addClass('account-visible');
		});

		$('.account-trigger').mouseleave(function(){
			$(this).removeClass('active');
			bodyContainer.removeClass('account-visible');
		});

		$('.account-box-wrapper' ).mouseenter(function(){
			$('.account-trigger').addClass('active');
			bodyContainer.addClass('account-visible');
		});

		$('.account-box-wrapper' ).mouseleave(function(){
			if(!$('.account-box #email, .account-box #passwort').is(':focus')){
		...
		$('.cart-trigger').click(function(e){
			e.preventDefault();
			if(bodyContainer.hasClass('nav-visible')){
				bodyContainer.removeClass('nav-visible');
			}
			if(bodyContainer.hasClass('account-visible')){
				bodyContainer.removeClass('account-visible');
			...
			$(this).toggleClass('active-fixed');
			bodyContainer.toggleClass('cart-visible');
			});
		...
		$('.account-trigger').click(function(e){
			...
			$(this).toggleClass('active-fixed');
			bodyContainer.toggleClass('account-visible');
		});

	}

	// Hide Mobile Nav on Keypress 'ESC'

	documentContainer.on('keyup',function(evt) {
		if (evt.keyCode == 27) {
			bodyContainer.removeClass('nav-visible');
		}
	});
	...
	function teaserButton(){
		...
		var active = $('#home-teaser ul li.active-slide');
		var data_top = active.attr('data-top');
		var data_bottom = active.attr('data-bottom');
		var data_color = active.attr('data-color');
		var data_link = $('a', active).attr('href');

		$('.home-teaser-button-content .top').html(data_top);
		$('.home-teaser-button-content .bottom').html(data_bottom);
		$('.home-teaser-button').css('background-color', data_color);
		$('.home-teaser-button-content').css('border-color', shadeColor(data_color, 300));
		$('.home-teaser-button .corner').css('border-color', shadeColor(data_color, -30) + ' transparent transparent');
		$('.home-teaser-button').attr('href', data_link);
	...
	var home_teaser = $('#home-teaser-slider').bxSlider({
		...
		onSlideBefore: function (currentSlideNumber, totalSlideQty, currentSlideHtmlObject) {
			...
			$('#home-teaser li').eq(currentSlideHtmlObject).addClass('active-slide');
			teaserButton();
			pagerUpdate();
		...
		onSliderLoad: function () {
			...
			$('#home-teaser li').eq(2).addClass('active-slide')
			$('#home-teaser .pager li').eq(2).addClass('active')
			teaserButton();
	...
	// STOP HOME TEASER ON HOVERS

	$('.home-teaser-button, .pager').hover(

		function(){

			home_teaser.stopAuto();

		},function(){

			home_teaser.startAuto();
	...
	function pagerUpdate(){
		...
		$('.pager li ').each(function(i){
			...
			var current = home_teaser.getCurrentSlide();
			if( i  == current){
				$(this).addClass('active');
			}
			else{
	...
	$('.pager a').each(function(i){
		...
		$(this).click(function(e){
			...
			e.preventDefault();
			home_teaser.goToSlide(i);

		});

	});

	// SHOW PRODUCT PROPERTY

	if(desktop == false){
		$('.product-item-properties li').click(function(){
		...
		$('#page').not('.product-item-properties li').click(function(){
			$('.product-item-properties li').removeClass('active');
		});
